...
import com.topica.tea.repository.QuestionRepository;
...
public class QuestionResourceIntTest {
    ...
    private static final EventType UPDATED_EVENT_TYPE = EventType.WORKSHOP;
    ...
    public void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.isIsMeatContent()).isEqualTo(DEFAULT_IS_MEAT_CONTENT);
        assertThat(testQuestion.getEventType()).isEqualTo(DEFAULT_EVENT_TYPE);
        assertThat(testQuestion.getAmplifyType()).isEqualTo(DEFAULT_AMPLIFY_TYPE);
    }
    ...
    public void updateQuestion() throws Exception {
        ...
        Question testQuestion = questionList.get(questionList.size() - 1);
        assertThat(testQuestion.isIsMeatContent()).isEqualTo(UPDATED_IS_MEAT_CONTENT);
        assertThat(testQuestion.getEventType()).isEqualTo(UPDATED_EVENT_TYPE);
        assertThat(testQuestion.getAmplifyType()).isEqualTo(UPDATED_AMPLIFY_TYPE);
    }
