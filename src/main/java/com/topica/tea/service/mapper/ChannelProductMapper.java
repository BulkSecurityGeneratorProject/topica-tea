 ...
 */
@Mapper(componentModel = "spring", uses = {ProductMapper.class, AdsTypeMapper.class, HtmlTemplateMapper.class})
public interface ChannelProductMapper extends EntityMapper <ChannelProductDTO, ChannelProduct> {

	@Mapping(source = "htmlTemplate.id", target = "htmlTemplateId")
	...
	@Mapping(source = "htmlTemplateId", target = "htmlTemplate")
