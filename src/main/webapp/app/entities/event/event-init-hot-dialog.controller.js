(function() {
    ...
    EventInitHotDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Event', 'Question', 'Article', 'Product', 'AdsType', 'ChannelProduct'];

    function EventInitHotDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Event, Question, Article, Product, AdsType, ChannelProduct) {
        var vm = this;
